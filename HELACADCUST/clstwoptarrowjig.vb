...
Public Class ClsTWOPTARROWJIG
    ...
    Public ReadOnly Property Thisdrawing() As AcadDocument
        ...
        End Get
    End Property
    <CommandMethod("TWOPOINT")> Public Sub StartJig()
    ...
    Autodesk.AutoCAD.EditorInput.SamplerStatus
        myPR = prompts.AcquirePoint("Select leader start point:")

        If myPR.Value.IsEqualTo(BasePt) Then
            Return SamplerStatus.NoChange
        Else

            If myPR.Value.X < BasePt.X Then
